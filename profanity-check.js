...
var curses = ["stupid", "idiot", "fucking", "bad"];
var path = "/Users/mathieu/Documents/projects/aotg/aotg-android";
var branch = "dev";
var reCurse = new RegExp("\\b(?:" + curses.join("|") + ")\\b", "gi");

// Default path is `.git`.
if (process.argv.length < 3) {
  console.log("No path passed as argument, defaulting to " + path);
}
// Otherwise defaults.
else {
  path = process.argv[2];
